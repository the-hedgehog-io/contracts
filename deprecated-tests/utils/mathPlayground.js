...
const ABDKOperations = async () => {
  ...
  // Example computaton: BaseFeeLMA -> Ether price conversion

  // price = 200.12345678, stored as uint
  // convert 6123456700909.123456789123456789 BaseFeeLMA to Ether
  // amount = 6123456700909.123456789123456789 BaseFeeLMA / 200.12345678
  ...
  console.log(`eth val is ${etherVal}`);
  ...
  // accurate to 22 digits.  So with 99 billion eth, it's accurate to 1 gwei.
  ...
  /* TODO: will L_WStETH, L_BaseFeeLMA overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
