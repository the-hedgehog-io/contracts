...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawBaseFeeLMA(...params) {
    return this.forwardFunction(
      params,
  ...
  async BaseFeeLMA_GAS_COMPENSATION(...params) {
    return this.proxyFunction("BaseFeeLMA_GAS_COMPENSATION", params);
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingBaseFeeLMADebtReward(...params) {
    return this.proxyFunction("getPendingBaseFeeLMADebtReward", params);
  }
  ...
  async L_BaseFeeLMADebt() {
    return this.proxyFunction("L_BaseFeeLMADebt", []);
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedBaseFeeLMADeposit(user) {
    return this.proxyFunctionWithUser("getCompoundedBaseFeeLMADeposit", user);
  }
...
class HOGStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token);
  }
  ...
  async F_BaseFeeLMA(user) {
    return this.proxyFunctionWithUser("F_BaseFeeLMA", user);
  }
}
